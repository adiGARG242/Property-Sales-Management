...
void removeProperty(std::list<Data>& l)
{
    ...
    // Find the property with the specified agent ID
    bool found = false;
    for (auto it = l.begin(); it != l.end(); ++it)
    {
        ...
        {
            found = true;
            l.erase(it); // Remove the property from the list
...
void addPropertyAgent(std::list<Data>& l)
{
   string agentid, password;
    ...
    // Create a new Data object for the agent
    Data agentData;
...
//         cout << "Please insert 'b' to see the list in descending order" << endl;
//         cout << "Enter any other key to return to the main menu" << endl;
//         cin >> option;
       
//         switch (option)
//         {
//             case 'a':
//                 l.sort([](const Data& d1, const Data& d2) {
//                     return d1.getSellingPrice() < d2.getSellingPrice();
//                 });
//                 break;
//             case 'b':
//                 l.sort([](const Data& d1, const Data& d2) {
...
//                 cout << "Agent ID: " << data.getAgentId() << endl;
//                 cout << "Contact: " << data.getContact() << endl;
//                 cout << "Property Size: " << data.getPropertySize() << endl;
//                 cout << "Room Type: " << data.getRoomType() << endl;
//                 cout << "Location: " << data.getLocation() << endl;
//                 cout << "Selling Price: " << data.getSellingPrice() << endl;
//                 cout << endl;
//             }
//         }
